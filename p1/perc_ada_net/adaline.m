...
%
% This script trains and tests an adaline
...
% Parse arguments
if (argc < 6)
  disp('Usage: ./adaline input_file_path out_file_path alpha train_proportion max_ages tolerance [real_problem_file]');
  return
end
...
tolerance = str2double(args_list{6});
if (argc >= 7)
